...
public class BuyableScrollMenu : MonoBehaviour
{
    ...
    private static List<string> baseUnitList = new List<string>() { 
        "guard1" ,
        "fent"
    };
    private List<string> unlockedUnitList = new List<string>();//this will change depending on player unlocks
    ...
    void Start()
    {
        nroOfUnits = baseUnitList.Count + unlockedUnitList.Count;
        ...
        int i = 0;
        foreach (string unit in baseUnitList) 
        { 
