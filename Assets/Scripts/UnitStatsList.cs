...
public class UnitStatsList : MonoBehaviour
{
    ...
    public static float[] bomber = new float[] { 0f, 0f, 15f, 0f, 0f, 0f, 0f, 25000f, 0f };         // 5
    ...
    public static string bomberImage = "Bomber";
    ...
    public static string bomberDesc = "Able to drop bombs on the enemies, by calling an airborne trough tower abilities.";
    public static List<string> IDList = new() { "Guard", "enemy1", "tower", "rangedEnemy", "Mortar" };
    public static List<float[]> unitStats = new() { guard1, enemy1, fent, rangedEnemy, mortar, bomber };
    public static List<string> unitImages = new() { guard1Image, enemy1Image, fentImage, rangedImage, mortarImage, bomberImage};
    public static List<string> unitDescriptions = new() { guard1Desc, enemy1Desc, fentDesc, rangedDesc, mortarDesc, bomberDesc };
}